...
// guaranteed half of the persisted artifact before common finalization runs.
...
export default function compactionSafeguardExtension(api: ExtensionAPI): void {
  api.on("session_before_compact", async (event, ctx) => {
    ...
    const finalizeSummaryText = async (
      ...
      // Match the native session owner's persistence bound before retention,
      // loss accounting and audit; a later blind cap must not change these facts.
