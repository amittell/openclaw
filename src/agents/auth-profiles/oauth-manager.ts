  ...
  constructor(params: {
    ...
    const structuredCause =
      typeof params.cause === "object" && params.cause !== null
        ? (params.cause as { code?: unknown; lockPath?: unknown; cause?: unknown }) // SAFETY: the ternary guard on the preceding lines proves cause is a non-null object; every asserted field is optional and compared before use.
        : undefined;
