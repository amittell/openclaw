...
// Widened from 120s so slow-startup telegram providers (bots with many commands or
// heavy first-poll payloads) finish the full handshake before the health monitor
// runs its first post-grace evaluation.
export const DEFAULT_CHANNEL_CONNECT_GRACE_MS = 300_000;
