...
export function buildGroupChatContext(params: {
  ...
  if (toolOnlyDelivery) {
    ...
    // Upstream 9.3 (#140901) dropped this close as a duplicate of the "reply only when
    // directly addressed" participation line, on a no-intended-behavior-change refactor.
    // The live A/B in the sibling test measured otherwise: the block must still END here.
